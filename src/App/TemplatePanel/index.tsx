  ...
  return (
    <>
      <Stack
        ...
        alignItems="center"
      >
        {enableSampleDrawer && <ToggleSamplesPanelButton />}
        <Stack px={2} direction="row" gap={2} width="100%" justifyContent="space-between" alignItems="center">
          <Stack direction="row" spacing={2}>
            <MainTabsGroup
              enableHtmlView={enableHtmlView}
              enableJSONView={enableJSONView}
              enablePrviewMode={enablePrviewMode}
            />
          </Stack>
          <Stack direction="row" spacing={2}>
            ...
            {enableShareCurentTemplate && <ShareButton />}
            <Tooltip title="Save Template Data">
